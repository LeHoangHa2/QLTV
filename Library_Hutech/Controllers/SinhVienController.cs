...
namespace Library_Hutech.Controllers
{
    public class SinhVienController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,MaSV,Lop,TimeUpdate,TimeCreate,HoTen")] SinhVien sinhVien)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MaSV,Lop,TimeUpdate,TimeCreate,HoTen")] SinhVien sinhVien)
        {
            if (ModelState.IsValid)
            {
