...
namespace Library_Hutech.Controllers
{
    public class NXBController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,MaNXB,TenNXB,TimeUpdate,TimeCreate,DiaChi")] NXB nXB)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,MaNXB,TenNXB,TimeUpdate,TimeCreate,DiaChi")] NXB nXB)
        {
            if (ModelState.IsValid)
            {
